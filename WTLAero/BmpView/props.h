...
#ifndef _WIN32_WCE
class CFileName : public aero::CWindowImpl<CFileName>
#else
...
public:
	...
	void Paint(CDCHandle dc, RECT& rClient, RECT& /*rView*/, RECT& /*rDest*/)
	{
		if(m_lpstrFilePath != NULL)
		{
			...
			if (aero::IsSupported() && IsTheming())
			{
				DrawText(dc, m_lpstrFilePath, &rClient, 
					DT_SINGLELINE | DT_LEFT | DT_VCENTER | DT_NOPREFIX | DT_PATH_ELLIPSIS, 
					DTT_COMPOSITED | DTT_GLOWSIZE, 10);
			}
			else
			{
				dc.SetTextColor(::GetSysColor(COLOR_WINDOWTEXT));
				dc.SetBkMode(TRANSPARENT);
				dc.DrawText(m_lpstrFilePath, -1, &rClient, DT_SINGLELINE | DT_LEFT | DT_VCENTER | DT_NOPREFIX | DT_PATH_ELLIPSIS);
			}
...
#ifndef _WIN32_WCE
		if (aero::IsSupported())
			OpenThemeData(L"static::globals");
...
#ifndef _WIN32_WCE
		CHAIN_MSG_MAP(aero::CWindowImpl<CFileName>)
...
class CPageOne : public aero::CPropertyPageImpl<CPageOne>
{
public:
	...
	BEGIN_MSG_MAP(CPageOne)
		...
		CHAIN_MSG_MAP(aero::CPropertyPageImpl<CPageOne>)
	END_MSG_MAP()
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		{
			AERO_CONTROL(CStatic, m_Location, IDC_FILELOCATION)
		...
		AERO_CONTROL(CStatic, m_L, IDC_L);
		AERO_CONTROL(CStatic, m_S, IDC_S);
		AERO_CONTROL(CStatic, m_Size, IDC_FILESIZE);
		AERO_CONTROL(CStatic, m_D, IDC_D);
		AERO_CONTROL(CStatic, m_Date, IDC_FILEDATE);
		AERO_CONTROL(CStatic, m_A, IDC_A);
		AERO_CONTROL(CStatic, m_Attrib, IDC_FILEATTRIB);

		return TRUE;
	}
};

class CPageTwo : public aero::CPropertyPageImpl<CPageTwo>
{
public:
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		AERO_CONTROL(CStatic, m_T, IDC_T)
		AERO_CONTROL(CStatic, m_Type, IDC_TYPE)
		AERO_CONTROL(CStatic, m_W, IDC_W)
		AERO_CONTROL(CStatic, m_Width, IDC_WIDTH)
		AERO_CONTROL(CStatic, m_H, IDC_H)
		AERO_CONTROL(CStatic, m_Height, IDC_HEIGHT)
		AERO_CONTROL(CStatic, m_HR, IDC_HR)
		AERO_CONTROL(CStatic, m_HorRes, IDC_HORRES)
		AERO_CONTROL(CStatic, m_VR, IDC_VR)
		AERO_CONTROL(CStatic, m_VertRes, IDC_VERTRES)
		AERO_CONTROL(CStatic, m_BD, IDC_BD)
		AERO_CONTROL(CStatic, m_BitDepth, IDC_BITDEPTH)
		AERO_CONTROL(CStatic, m_C, IDC_C)
		AERO_CONTROL(CStatic, m_Compression, IDC_COMPRESSION)

		return TRUE;
	}
};

class CPageThree : public aero::CPropertyPageImpl<CPageThree>
{
public:
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		AERO_CONTROL(CStatic, m_WL, IDC_W)
		AERO_CONTROL(CStatic, m_HL, IDC_H)
		AERO_CONTROL(CStatic, m_HRL, IDC_HR)
		AERO_CONTROL(CStatic, m_VRL, IDC_VR)
		AERO_CONTROL(CStatic, m_BDL, IDC_BD)

		AERO_CONTROL(CStatic, m_W, IDC_WIDTH)
		AERO_CONTROL(CStatic, m_H, IDC_HEIGHT)
		AERO_CONTROL(CStatic, m_HR, IDC_HORRES)
		AERO_CONTROL(CStatic, m_VR, IDC_VERTRES)
		AERO_CONTROL(CStatic, m_BD, IDC_BITDEPTH)

		return TRUE;
	}
};

class CBmpProperties : public aero::CPropertySheetImpl<CBmpProperties>
{
public:
	CPageOne m_page1;
	CPageTwo m_page2;
